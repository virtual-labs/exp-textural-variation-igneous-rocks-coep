...
var htm='<div class="row">'
			...
			+'</div>'
			+'<div class="col-sm-2">'
			+'<center><strong><span style="float:center;">Select igneous texture</span></strong></center>'
			+'</div>'
			+'<div class="col-sm-7">'
...
var thoery='<div class="container col-sm-12"  id="theory">'
	...
	+' <li><b>Depth of cooling and volume of magma:</b> Higher the depth, slower will be the cooling rate as heat deccipiation is slow. Similarly, volume of the magma have significant bearing on crystal growth. Larger the volume slower will be the rate of cooling, hence larger crystals will be formed.</li>'
	+'<li><b>Composition and viscosity of magma:</b>- Highly viscous lavas such as rhyolite or siliceous magma favours formation of non-crystalline and/or glassy rocks. Contrarily, less viscous basaltic or mafic lavas/magmas give rise to crystalline rocks e.g. phyric and aphyric basalts. Magma with high viscosity have high volatile content as compared to less viscous magmas</li>'
	+'</ul>'
	+'</p>'
	+'<p><br>'
	+'</p>'
	 ...
	 var mineral=parseInt(tempmineral);
		for(i=0,j=1;i<tempMasterJson.demo.length;i++,j++){	
			 if(mineral==tempMasterJson.demo[i].mineralId){	
				 copyMineralid=i;
				// textureName=["Poikilitic texture","Pyroclastic texture","Replacement texture","Poikilitic texture","Directive texture","Graphic texture"]
				 var text='<div class="col-lg-2  col-sm-12">'
					 	...
					 	text+='</div>'
						+'<br>'
					 	+'<strong><b>Which texture of above igneous rocks?</b></strong>'
					 	+'<br>'
					 	+'<br>'
